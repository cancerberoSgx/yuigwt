...
//	}
	...
	public static native final int setTimeout(SimpleCallback callback, int ms)/*-{
		var f = $entry(function(){
			return callback.@org.sgx.yuigwt.yui.util.SimpleCallback::call()(); 
		}); 
...
//		return @org.sgx.yuigwt.yui.util.JsUtil::toJsArray([Lcom/google/gwt/core/client/JavaScriptObject;)(t); 
	...
	public static final native JsFunction toJsFunction(Callback c)/*-{
		return $entry(function(){
			return c.@org.sgx.yuigwt.yui.util.Callback::call(Lcom/google/gwt/core/client/JsArrayMixed;)(arguments); 
		}); 
	//	return @org.sgx.yuigwt.yui.util.JsUtil::toJsArray([Lcom/google/gwt/core/client/JavaScriptObject;)(t); 
	}-*/;
	...
	public static final native JsFunction toJsFunction(CallbackString c)/*-{
		return $entry(function(){
			return c.@org.sgx.yuigwt.yui.util.CallbackString::call(Lcom/google/gwt/core/client/JsArrayMixed;)(arguments);  
		}); 
	//	return @org.sgx.yuigwt.yui.util.JsUtil::toJsArray([Lcom/google/gwt/core/client/JavaScriptObject;)(t); 
	}-*/;
	...
	public static final native JsFunction toJsFunction(CallbackObject c)/*-{
		return $entry(function(){
			return c.@org.sgx.yuigwt.yui.util.CallbackObject::call(Lcom/google/gwt/core/client/JsArrayMixed;)(arguments);   
		}); 
	//	return @org.sgx.yuigwt.yui.util.JsUtil::toJsArray([Lcom/google/gwt/core/client/JavaScriptObject;)(t); 
	}-*/;
	...
	public static final native JsFunction toJsFunction(AbstractCallback c)/*-{
		return $entry(function(){
			return c.@org.sgx.yuigwt.yui.util.AbstractCallback::call(*)(arguments);    
		}); 
	//	return @org.sgx.yuigwt.yui.util.JsUtil::toJsArray([Lcom/google/gwt/core/client/JavaScriptObject;)(t); 
	}-*/;
