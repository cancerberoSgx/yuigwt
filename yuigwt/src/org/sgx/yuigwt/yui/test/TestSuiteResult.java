 ...
 *
 */
public class TestSuiteResult extends JsObject{
 ...
 */
public native final TestSuiteResult failed(int val) /*-{
this.failed = val; 
return this; 
}-*/;
 ...
 * @return this - for setter chaining
 */
public native final TestSuiteResult passed(int val) /*-{
this.passed = val; 
return this; 
}-*/;
 ...
 * @return this - for setter chaining
 */
public native final TestSuiteResult ignored(int val) /*-{
this.ignored = val; 
return this; 
}-*/;
 ...
 * @return this - for setter chaining
 */
public native final TestSuiteResult total(int val) /*-{
this.total = val; 
return this; 
}-*/;
/**
 ...
 * @return this - for setter chaining
 */
public native final TestSuiteResult type(String val) /*-{
this.type = val; 
return this; 
}-*/;
/**
 ...
 * @return this - for setter chaining
 */
public native final TestSuiteResult name(String val) /*-{
this.name = val; 
return this; 
}-*/;
public native final JsArrayString getTestCaseNames() /*-{
var arr = []; 
for(var i in this) {
	var propName = i+""; 
...
public native final TestCaseResult getTestCaseResult(String testMethodName) /*-{
